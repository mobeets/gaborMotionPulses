...
for jj = 1:numel(dts)
    ...
    pts = [pts; cpts];
    plot(cpts(:,1), cpts(:,2), 'k.', 'MarkerSize', 20);
end
...
ks = [2]; % 2 = pairs, 3 = triplets, 4 = quads, etc. (can include multiple)
...
% - compare to fitting weights to shuffled OR unshuffled data
